...
import java.util.stream.Stream;
    ...
    public class SimulationTestNoRun {
        ...
        public void test7_recogniseKnife (){
            ...
            Assertions.assertEquals("KNIFE" , build.getBaggageScanner().getScanResults().getFirst().getResult().getItemType().name());
        }
        ...
        public void test8_recogniseWeapon (){
            ...
            Assertions.assertEquals("WEAPON" , build.getBaggageScanner().getScanResults().get(2).getResult().getItemType().name());
        }
        ...
        public void test9_recogniseExplosive (){
            ...
            Assertions.assertEquals("EXPLOSIVE" , build.getBaggageScanner().getScanResults().get(0).getResult().getItemType().name());
        }
    }
